package com.youngermaster.arduinocarcontroller;
...
public class Controlling extends Activity {
    ...
    final static String GO = "1";
    final static String BACK = "2";
    final static String RIGHT = "3";
    final static String LEFT = "4";

    private ProgressDialog progressDialog;
    Button btnGo, btnBack, btnRight, btnLeft;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGo = findViewById(R.id.go); // (Button)
        ...
        btnGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    mBTSocket.getOutputStream().write(GO.getBytes());
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }});
